The example output file shows the **first five rows** of the expected query result. If your queries are written correctly then you will have an exact match. <br>
